...
using Niue.WeChat.Core.Utilities.XmlUtility;
using Niue.WeChat.Open.Entities.Request;
using Niue.WeChat.Open.Tencent;

namespace Niue.WeChat.Open.ThirdPartyMessageHandlers
{
