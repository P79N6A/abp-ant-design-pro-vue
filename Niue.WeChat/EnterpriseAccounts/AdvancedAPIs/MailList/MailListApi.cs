...
using Niue.WeChat.EnterpriseAccounts.AdvancedAPIs.MailList.Department;
using Niue.WeChat.EnterpriseAccounts.AdvancedAPIs.MailList.Member;
using Niue.WeChat.EnterpriseAccounts.AdvancedAPIs.MailList.Tag;
using Niue.WeChat.EnterpriseAccounts.CommonAPIs;

namespace Niue.WeChat.EnterpriseAccounts.AdvancedAPIs.MailList
{
    public static class MailListApi
    {
        ...
        public static async Task<CreateDepartmentResult> CreateDepartmentAsync(string accessToken, string name, int parentId, int order = 1, int? id = null, int timeOut = Config.TIME_OUT)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<CreateDepartmentResult>(null, url, data, CommonJsonSendType.POST, timeOut);
        }
        ...
        public static async Task<InviteMemberResult> InviteMemberAsync(string accessToken, string userId, int timeOut = Config.TIME_OUT)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<InviteMemberResult>(null, url, data, CommonJsonSendType.POST, timeOut);
        }
        ...
        public static async Task<CreateTagResult> CreateTagAsync(string accessToken, string tagName, int? tagId = null, int timeOut = Config.TIME_OUT)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<CreateTagResult>(accessToken, url, data, CommonJsonSendType.POST, timeOut);
        }
        ...
        /// <param name="tagId">标签ID</param>
        /// <returns></returns>
        public static async Task<GetTagMemberResult> GetTagMemberAsync(string accessToken, int tagId)
        {
            var url = string.Format("https://qyapi.weixin.qq.com/cgi-bin/tag/get?access_token={0}&tagid={1}", accessToken.AsUrlData(), tagId);
        ...
        /// <param name="timeOut">代理请求超时时间（毫秒）</param>
        /// <returns></returns>
        public static async Task<AddTagMemberResult> AddTagMemberAsync(string accessToken, int tagId, string[] userList = null, int[] partyList = null, int timeOut = Config.TIME_OUT)
        {
            var url = "https://qyapi.weixin.qq.com/cgi-bin/tag/addtagusers?access_token={0}";
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<AddTagMemberResult>(accessToken, url, data, CommonJsonSendType.POST, timeOut);
        }
        ...
        public static async Task<DelTagMemberResult> DelTagMemberAsync(string accessToken, int tagId, string[] userList, int timeOut = Config.TIME_OUT)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<DelTagMemberResult>(accessToken, url, data, CommonJsonSendType.POST, timeOut);
        }
        ...
        /// <param name="accessToken"></param>
        /// <returns></returns>
        public static async Task<GetTagListResult> GetTagListAsync(string accessToken)
        {
            var url = string.Format("https://qyapi.weixin.qq.com/cgi-bin/tag/list?access_token={0}", accessToken.AsUrlData());
