...
using Niue.WeChat.EnterpriseAccounts.AdvancedAPIs.Asynchronous.AsynchronousJson;
using Niue.WeChat.EnterpriseAccounts.CommonAPIs;

namespace Niue.WeChat.EnterpriseAccounts.AdvancedAPIs.Asynchronous
{
    /// <summary>
    /// 异步任务接口
    /// </summary>
    public static class AsynchronousApi
    {
        ...
        */
        ...
        public static async Task<AsynchronousJobId> BatchInviteUserAsync(string accessToken, string toUser, string toParty, string toTag, string inviteTips, Asynchronous_CallBack callBack, int timeOut = Config.TIME_OUT)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<AsynchronousJobId>(accessToken, url, data, CommonJsonSendType.POST, timeOut);
        }
