...
using Niue.WeChat.EnterpriseAccounts.Entities.Response;

namespace Niue.WeChat.EnterpriseAccounts.AdvancedAPIs.Media
{
    /// <summary>
    /// 多媒体文件接口
    /// </summary>
    public static class MediaApi
    {
        ...
        {
            var url = string.Format("https://qyapi.weixin.qq.com/cgi-bin/media/upload?access_token={0}&type={1}", accessToken.AsUrlData(), type);
        ...
        public static void Get(string accessToken, string mediaId, Stream stream)
        {
            ...
            Core.Utilities.HttpUtility.Get.Download(url, stream);//todo 异常处理
        }
        ...
        public static async Task GetAsync(string accessToken, string mediaId, Stream stream)
        {
            var url = string.Format("https://qyapi.weixin.qq.com/cgi-bin/media/get?access_token={0}&media_id={1}",
                accessToken.AsUrlData(), mediaId.AsUrlData());
            await Core.Utilities.HttpUtility.Get.DownloadAsync(url, stream);//todo 异常处理
        }
        ...
        public static async Task<UploadForeverResultJson> AddMpNewsAsync(string accessToken, int agentId, int timeOut = Config.TIME_OUT, params MpNewsArticle[] mpNewsArticles)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<UploadForeverResultJson>(null, url, data, CommonJsonSendType.POST, timeOut);
        }
        ...
        public static async Task<GetForeverMpNewsResult> GetForeverMpNewsAsync(string accessToken, int agentId, string mediaId)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<GetForeverMpNewsResult>(null, url, null, CommonJsonSendType.GET);
        }
        ...
        public static async Task<QyJsonResult> DeleteForeverMaterialAsync(string accessToken, int agentId, string mediaId)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<QyJsonResult>(null, url, null, CommonJsonSendType.GET);
        }
        ...
        public static async Task<GetCountResult> GetCountAsync(string accessToken, int agentId)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<GetCountResult>(null, url, null, CommonJsonSendType.GET);
        }
        ...
        public static async Task<UploadimgMediaResult> UploadimgMediaAsync(string accessToken, string media, int timeOut = Config.TIME_OUT)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<UploadimgMediaResult>(null, url, data, CommonJsonSendType.POST, timeOut);
        }
        #endregion
    }
}
