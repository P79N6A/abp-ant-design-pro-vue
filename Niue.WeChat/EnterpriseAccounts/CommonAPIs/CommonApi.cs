...
using Niue.WeChat.EnterpriseAccounts.Containers;
using Niue.WeChat.EnterpriseAccounts.Entities.JsonResult;

namespace Niue.WeChat.EnterpriseAccounts.CommonAPIs
{
    /// <summary>
    /// 通用基础API
    /// </summary>
...
*/
        ...
        public static async Task<ProviderTokenResult> GetProviderTokenAsync(string corpId, string providerSecret, int timeOut = Config.TIME_OUT)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<ProviderTokenResult>(null, url, data, CommonJsonSendType.POST, timeOut);
        }
        ...
        public static async Task<ConvertToOpenIdResult> ConvertToOpenIdAsync(string accessToken, string userId, string agentId = null, int timeOut = Config.TIME_OUT)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<ConvertToOpenIdResult>(null, url, data, CommonJsonSendType.POST, timeOut);
        }
        ...
        public static async Task<ConvertToUserIdResult> ConvertToUserIdAsync(string accessToken, string openId, int timeOut = Config.TIME_OUT)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<ConvertToUserIdResult>(null, url, data, CommonJsonSendType.POST, timeOut);
        }
        #endregion
    }
}
