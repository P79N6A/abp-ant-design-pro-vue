...
using System.Text;
using System.Xml;
using Niue.WeChat.PublicAccounts.TenPayLibV3.Entities;

namespace Niue.WeChat.PublicAccounts.TenPayLibV3
{
    /// <summary>
    /// 红包发送和查询Api（暂缺裂变红包发送）
    /// </summary>
