...
using Niue.WeChat.PublicAccounts.AdvancedAPIs.AutoReply.AutoReplyJson;
using Niue.WeChat.PublicAccounts.CommonAPIs;

namespace Niue.WeChat.PublicAccounts.AdvancedAPIs.AutoReply
{
    /// <summary>
    /// 获取自动回复规则
    /// </summary>
    public static class AutoReplyApi
    {
        ...
        public static async Task<GetCurrentAutoreplyInfoResult> GetCurrentAutoreplyInfoAsync(string accessTokenOrAppId)
        {
            return await ApiHandlerWapper.TryCommonApiAsync(accessToken =>
            {
                ...
                return Core.CommonAPIs.CommonJsonSend.SendAsync<GetCurrentAutoreplyInfoResult>(accessToken, urlFormat, null, CommonJsonSendType.GET);
