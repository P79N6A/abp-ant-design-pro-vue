...
namespace Niue.WeChat.PublicAccounts.AdvancedAPIs.MerChant.Group
{
    /// <summary>
    /// 微小店分组接口
    /// </summary>
    public static class GroupApi
    {
        ...
        public static async Task<AddGroupResult> AddGroupAsync(string accessToken, AddGroupData addGroupData)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<AddGroupResult>(accessToken, urlFormat, addGroupData);
        }
        ...
        public static async Task<WxJsonResult> PropertyModGroupAsync(string accessToken, PropertyModGroup propertyModGroup)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<WxJsonResult>(accessToken, urlFormat, propertyModGroup);
        }
        ...
        public static async Task<WxJsonResult> ProductModGroupAsync(string accessToken, ProductModGroup productModGroup)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<WxJsonResult>(accessToken, urlFormat, productModGroup);
        }
        ...
        public static async Task<GetAllGroup> GetAllGroupAsync(string accessToken)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<GetAllGroup>(accessToken, urlFormat, null, CommonJsonSendType.GET);
        }
        ...
        public static async Task<GetByIdGroup> GetByIdGroupAsync(string accessToken, int groupId)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<GetByIdGroup>(accessToken, urlFormat, data);
        }
        #endregion
    }
}
