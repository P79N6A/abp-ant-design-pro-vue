...
namespace Niue.WeChat.PublicAccounts.AdvancedAPIs.MerChant.Stock
{
    /// <summary>
    /// 微小店库存接口
    /// </summary>
    public static class StockApi
    {
        ...
        public static async Task<WxJsonResult> AddStockAsync(string accessToken, AddStockData addStockData)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<WxJsonResult>(accessToken, urlFormat, addStockData);
        }
        ...
        public static async Task<WxJsonResult> ReduceStockAsync(string accessToken, ReduceStockData reduceStockData)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<WxJsonResult>(accessToken, urlFormat, reduceStockData);
        }
        #endregion
