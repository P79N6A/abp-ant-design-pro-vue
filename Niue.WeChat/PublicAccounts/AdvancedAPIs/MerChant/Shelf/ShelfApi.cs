...
namespace Niue.WeChat.PublicAccounts.AdvancedAPIs.MerChant.Shelf
{
    /// <summary>
    /// 微小店货架接口
    /// </summary>
    public static class ShelfApi
    {
        ...
        public static async Task<AddShelfResult> AddShelvesAsync(string accessToken, M1 m1, M2 m2, M3 m3, M4 m4, M5 m5, string shelfBanner, string shelfName)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<AddShelfResult>(accessToken, urlFormat, data);
        }
        ...
        public static async Task<GetAllShelfResult> GetAllShelvesAsync(string accessToken)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<GetAllShelfResult>(accessToken, urlFormat, null, CommonJsonSendType.GET);
        }
        ...
        public static async Task<GetByIdShelfResult> GetByIdShelvesAsync(string accessToken, int shelfId)
        {
            ...
            return await Core.CommonAPIs.CommonJsonSend.SendAsync<GetByIdShelfResult>(accessToken, urlFormat, data);
        }
        #endregion
