...
using Niue.WeChat.PublicAccounts.AdvancedAPIs.Groups.GroupsJson;
using Niue.WeChat.PublicAccounts.CommonAPIs;

namespace Niue.WeChat.PublicAccounts.AdvancedAPIs.Groups
{
    ...
    public static class GroupsApi
    {
        ...
        /// <param name="accessTokenOrAppId"></param>
        /// <returns></returns>
        public static GroupsJson.GroupsJson Get(string accessTokenOrAppId)
        {
            return ApiHandlerWapper.TryCommonApi(accessToken =>
            {
                ...
                return Core.Utilities.HttpUtility.Get.GetJson<GroupsJson.GroupsJson>(url);
        ...
        public static async Task<CreateGroupResult> CreateAsync(string accessTokenOrAppId, string name, int timeOut = Config.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync( accessToken =>
            {
                ...
                return Core.CommonAPIs.CommonJsonSend.SendAsync<CreateGroupResult>(accessToken, urlFormat, data, timeOut: timeOut);
        ...
        /// <param name="accessTokenOrAppId"></param>
        /// <returns></returns>
        public static async Task<GroupsJson.GroupsJson> GetAsync(string accessTokenOrAppId)
        {
            return await ApiHandlerWapper.TryCommonApiAsync( accessToken =>
            {
                var urlFormat = "https://api.weixin.qq.com/cgi-bin/groups/get?access_token={0}";
                var url = string.Format(urlFormat, accessToken.AsUrlData());
                return Core.Utilities.HttpUtility.Get.GetJsonAsync<GroupsJson.GroupsJson>(url);
        ...
        public static async Task<GetGroupIdResult> GetIdAsync(string accessTokenOrAppId, string openId, int timeOut = Config.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync( accessToken =>
            {
                var urlFormat = "https://api.weixin.qq.com/cgi-bin/groups/getid?access_token={0}";
                var data = new { openid = openId };
                return Core.CommonAPIs.CommonJsonSend.SendAsync<GetGroupIdResult>(accessToken, urlFormat, data, timeOut: timeOut);
        ...
        public static async Task<WxJsonResult> UpdateAsync(string accessTokenOrAppId, int id, string name, int timeOut = Config.TIME_OUT)
        {
            return await ApiHandlerWapper.TryCommonApiAsync( accessToken =>
            {
                ...
                return Core.CommonAPIs.CommonJsonSend.SendAsync(accessToken, urlFormat, data, timeOut: timeOut);
        ...
        public static async Task<WxJsonResult> BatchUpdateAsync(string accessTokenOrAppId, int toGroupId, int timeOut = Config.TIME_OUT, params string[] openIds)
        {
            return await ApiHandlerWapper.TryCommonApiAsync( accessToken =>
            {
                ...
                return Core.CommonAPIs.CommonJsonSend.SendAsync<WxJsonResult>(accessToken, urlFormat, data, CommonJsonSendType.POST, timeOut);
