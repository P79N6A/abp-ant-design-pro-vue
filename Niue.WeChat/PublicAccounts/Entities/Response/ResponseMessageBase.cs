...
{
	public interface IResponseMessageBase : Core.Entities.Response.IResponseMessageBase
	{
	...
	/// 微信公众号响应回复消息
	/// </summary>
    public class ResponseMessageBase : Core.Entities.Response.ResponseMessageBase, IResponseMessageBase
	{
