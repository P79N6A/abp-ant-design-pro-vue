...
using Niue.WeChat.PublicAccounts.AppStore.Api;
using Niue.WeChat.PublicAccounts.AppStore.Entities.AppResult;
using Niue.WeChat.PublicAccounts.AppStore.Entities.Passports;

namespace Niue.WeChat.PublicAccounts.AppStore
{
