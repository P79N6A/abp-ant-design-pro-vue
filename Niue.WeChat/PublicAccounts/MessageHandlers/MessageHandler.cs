...
using Niue.WeChat.PublicAccounts.AppStore;
using Niue.WeChat.PublicAccounts.Entities;
...
using Niue.WeChat.PublicAccounts.Tencent;
...
namespace Niue.WeChat.PublicAccounts.MessageHandlers
{
        ...
        where TC : class, IMessageContext<IRequestMessageBase, IResponseMessageBase>, new()
    {
        ...
        {
            //消息去重
            if ((OmitRepeatedMessageFunc == null || OmitRepeatedMessageFunc(RequestMessage)) 
