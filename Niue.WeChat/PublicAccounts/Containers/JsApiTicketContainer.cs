...
using Niue.WeChat.PublicAccounts.Entities.JsonResult;
...
namespace Niue.WeChat.PublicAccounts.Containers
{
    ...
    public class JsApiTicketBag : BaseContainerBag, IBaseContainerBag_AppId
    {
        ...
        public JsApiTicketResult JsApiTicketResult
        {
            ...
            set { SetContainerProperty(ref _jsApiTicketResult, value); }
        }

        public DateTime JsApiTicketExpireTime
        {
            get { return _jsApiTicketExpireTime; }
            set { SetContainerProperty(ref _jsApiTicketExpireTime, value); }
        }
