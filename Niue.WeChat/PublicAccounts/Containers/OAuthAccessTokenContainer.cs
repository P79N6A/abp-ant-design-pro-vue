...
using Niue.WeChat.PublicAccounts.AdvancedAPIs.OAuth;
using Niue.WeChat.PublicAccounts.AdvancedAPIs.OAuth.OAuthJson;

namespace Niue.WeChat.PublicAccounts.Containers
{
    /// <summary>
    /// OAuth包
    /// </summary>
    ...
    public class OAuthAccessTokenBag : BaseContainerBag, IBaseContainerBag_AppId
    {
        ...
        {
            get { return _appId; }
            set { SetContainerProperty(ref _appId, value); }
        }
        public string AppSecret
        {
            get { return _appSecret; }
            set { SetContainerProperty(ref _appSecret, value); }
        }

        public OAuthAccessTokenResult OAuthAccessTokenResult
        {
            get { return _oAuthAccessTokenResult; }
            set { SetContainerProperty(ref _oAuthAccessTokenResult, value); }
        }

        public DateTime OAuthAccessTokenExpireTime
        {
            get { return _oAuthAccessTokenExpireTime; }
            set { SetContainerProperty(ref _oAuthAccessTokenExpireTime, value); }
        }
