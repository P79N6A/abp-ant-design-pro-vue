...
using Niue.WeChat.Core.Cache.CacheStrategy;
using Niue.WeChat.Core.Cache.Lock;
using Niue.WeChat.Core.Containers;

namespace Niue.WeChat.Core.Cache.ContainerCacheStragegy.LocalContainerCacheStrategy
{
    /// <summary>
    /// 全局静态数据源帮助类
    /// </summary>
