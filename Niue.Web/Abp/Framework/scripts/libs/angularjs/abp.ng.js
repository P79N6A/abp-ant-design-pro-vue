(function (abp, angular) {
    ...
    abp.ng.http = {
        defaultError: {
            message: "服务器错误",
            details: "请联系系统管理员查看错误详情。"
        },

        defaultError401: {
            message: "您没有认证！",
            details: "您应该进行身份验证（登录）才能执行此操作。"
        },
    ...
    abp.event.on("abp.dynamicScriptsInitialized", function () {
        abp.ng.http.defaultError.message = abp.localization.abpWeb("(Default)服务器错误");
        abp.ng.http.defaultError.details = abp.localization.abpWeb("请联系系统管理员查看错误详情。");
        abp.ng.http.defaultError401.message = abp.localization.abpWeb("(401)您没有认证！");
        abp.ng.http.defaultError401.details = abp.localization.abpWeb("您应该进行身份验证（登录）才能执行此操作。");
        abp.ng.http.defaultError403.message = abp.localization.abpWeb("(403)你没有被授权！");
        abp.ng.http.defaultError403.details = abp.localization.abpWeb("您不被允许执行此操作。");
        abp.ng.http.defaultError404.message = abp.localization.abpWeb("(404)资源未找到");
        abp.ng.http.defaultError404.details = abp.localization.abpWeb("服务器上找不到请求的资源。");
    });
